...
import { Sun, Moon, Monitor, Palette, LogOut, Menu, X, Home, ShoppingBag, Wallet, Activity, User, Code2, FileText, Gift } from 'lucide-react';
        ...
        <>
          ...
          <div className="fixed left-0 top-0 z-[70] flex h-full w-4/5 max-w-xs flex-col bg-slate-900 shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-5 space-y-1">
              ...
              {/* =============================================
                  MENU BARU: DAPATKAN SALDO GRATIS
                  ============================================= */}
              <button 
                onClick={() => handleSideNav('/referral')} 
                className="flex w-full items-center gap-4 rounded-xl px-4 py-3.5 text-left transition-colors hover:bg-slate-800 group"
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-amber-500/20 group-hover:bg-amber-500/30 transition-colors">
                  <Gift size={18} className="text-amber-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <span className="font-semibold text-amber-400 group-hover:text-amber-300">Dapatkan Saldo Gratis</span>
                  <p className="text-[10px] text-slate-500 group-hover:text-slate-400 mt-0.5">Program Referral</p>
                </div>
